...
import { LayoutDashboard, Package, ShoppingBag, Users, MessageSquare, Settings, PlusCircle, CheckCircle, BarChart3, Leaf, ArrowRight, Zap, Brain } from 'lucide-react';
...
const Sidebar: React.FC = () => {
  ...
  const menuItems = [
    ...
    { icon: Brain,           label: 'Conseils IA',       path: '/conseils',              roles: ['Agriculteur', 'Producteur', 'Fournisseur', 'Acheteur', 'Administrateur'] },
