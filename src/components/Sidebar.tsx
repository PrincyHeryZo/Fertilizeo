...
import {
  ...
  MessageSquare, Settings, PlusCircle, CheckCircle, BarChart3, Leaf
} from 'lucide-react';
...
const Sidebar: React.FC = () => {
  ...
  const gradient = roleColors[user?.role || ''] || 'from-emerald-400 to-teal-500';

  return (
    <aside className="w-64 bg-white border-r border-gray-100 h-[calc(100vh-64px)] sticky top-16 hidden md:flex flex-col overflow-hidden">
      {/* User Card */}
      <div className="p-5 border-b border-gray-100">
        <div className={`bg-gradient-to-br ${gradient} rounded-2xl p-4 text-white`}>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center text-lg font-black">
